	local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/BallsOverLord/AgonyLib/main/AgonyLib.txt"))()
	...
	--[[
		Text = Tabs name
		Image = Image announcement uses
		RGBInput = {Red, Green, Blue}
		Time = Time announcement is alive for
	--]]
	CreateAnnouncement("Announcement!", 12902044900, {0, 0, 0}, 10)

	--(TextM, TextS, Callback)
	--[[
		TextM = Main text
	...
	--]]
	Yes = false
	CreateYesNoPromt("YesNo", "Text", function(Toggle)
		if Toggle then
			Yes = Toggle
		end
	end)
